"""3-way speed benchmark for the Upstage Solar models
(original HF-eager bf16 / plain vLLM bf16 / fastserve
...
MODELS = [
    ("upstage/SOLAR-10.7B-Instruct-v1.0", False),
    ("upstage/solar-pro-preview-instruct", False),
]
